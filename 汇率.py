...
YOUR_GEMINI_KEY = "AIzaSyBvJcfIUbpgNuy29LnHVhLTJ1ibIzkhi8U"
...
st.set_page_config(
    page_title="EUR/USD Pro v42.0 (Precision Fix)",
    page_icon="🌗",
    layout="wide",
...
def main():
    ...
    with st.sidebar:
        st.title("🌗 Pro v42.0 (Precision)")
        st.caption("深色/浅色模式完美适配")
        
        st.markdown("---")
        st.text_input("Gemini Key", st.session_state.key, type="password")
